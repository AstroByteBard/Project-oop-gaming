...
public class Voting {
    ...
    public static void Question(){
        System.out.println("\nQuestion 1: What kind of leader do you want for the world? (A or B)");
        ...
        Ans();
        System.out.println("\nQuestion 2: What perspective do you want a world leader to have? (A or B)");
        ...
        Ans();
        System.out.println("\nQuestion 3: Do you want a world leader who understands the environment or technology? (A or B)");
        ...
        Ans();
        System.out.println("\nQuestion 4: What kind of background do you want a world leader to come from? (A or B)");
        ...
        Ans();
        System.out.println("\nQuestion 5: What principles should a world leader adhere to? (A or B)");
